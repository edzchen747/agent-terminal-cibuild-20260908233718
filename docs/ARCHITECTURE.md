...
- The tray validates that an attachment's session belongs to the webview's assigned project. Project reassignment clears the old window's subscriptions before either window renders its new tab set.
